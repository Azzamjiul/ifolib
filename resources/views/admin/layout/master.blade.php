...
<html lang="en" class="no-focus">
    <head>
        ...
        <!-- Page JS Plugins CSS -->
        <link rel="stylesheet" href="{{ asset('assets/js/plugins/slick/slick.cs') }}s">
    ...
    <body>
                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li class="nav-main-heading"><span class="sidebar-mini-visible">UI</span><span class="sidebar-mini-hidden">OER</span></li>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="be_blocks_draggable.html">Subject</a>
                                    </li>
                                    <li>
                                        <a href="be_blocks_api.html">Type</a>
                                    </li>
                                </ul>
                            </li>
                            <!-- <li>
        ...
        <!--
            ...
            to handle those dependencies through webpack. Please check out {{ asset('') }}assets/_es6/main/bootstrap.js for more info.
