        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 style="display:inline-block">Mengubah Mata Pelajaran</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.oer.subject.update', $subject->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="" cols="30" rows="5" class="form-control @error('description') is-invalid @enderror">{{ $subject->description }}</textarea>
                            @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
