		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-12 text-center">
					...
					<a href="https://docs.google.com/forms/d/146DmJOfDpYcoG6sAGC7MeVSEi6C_yOmXGru9IuADN68/viewform" class="btn btn-primary text-1 btn-outline custom-btn-style-1 font-weight-semibold appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1900" data-plugin-options="{'accY': 100}" style="margin:10px 10px">SURVEY KEPUASAN REPOSITORY ITS</a>
					...
					<a href="https://docs.google.com/forms/d/1GbnZb3XPj4F9CzZKhHUEkgpt5DRT_ZSX31OCNkI4c-8/edit" class="btn btn-primary text-1 btn-outline custom-btn-style-1 font-weight-semibold appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1900" data-plugin-options="{'accY': 100}" style="margin:10px 10px">SURVEY KEBUTUHAN INFORMASI</a>
